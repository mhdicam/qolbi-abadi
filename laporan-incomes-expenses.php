  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Laporan Incomes Expenses</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="bo">Home</a></li>
              <li class="breadcrumb-item active">Incomes/Expenses</li>
            </ol>
          </div>
        </div><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form role="form" action="laporan-detail-incomes-expenses" method="POST" target="_blank">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
